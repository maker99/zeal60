...
do 
echo Keymap $i
sudo ../zeal60/zealM104 get_keymap $i
echo
done

sudo ../zeal60/zealM104 keymap 0 \
RGB_TOG RGB_MOD KC_SLCK KC_LBRC KC_J    KC_7    KC_SCLN KC_PSLS KC_NO   KC_BSLS KC_TAB          KC_NO   KC_RALT KC_L    KC_P5   KC_NO   KC_NO    \
